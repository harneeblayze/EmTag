...
public class CameraActivity extends CameraBaseActivity {
    ...
    Button takePicture;
    @InjectView(R.id.takepicture1)
    Button takePicture1;
    @InjectView(R.id.takepicture2)
    Button takePicture2;
    @InjectView(R.id.takepicture3)
    Button takePicture3;
...
//        layout.height = 0;
        ...
        ArrayList<PhotoItem> sysPhotos = FileUtils.getInst().findPicsInDir(
                FileUtils.getInst().getIconPhotoPath());
...
//            }
    ...
    private void setUpCamera(int mCurrentCameraId2) {
        ...
        if (cameraInst != null) {
            ...
            toast("Switch failure，Please try again！", Toast.LENGTH_LONG);
